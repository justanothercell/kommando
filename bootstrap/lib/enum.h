...
#define ENUM(name, ...) typedef enum name { FIELDS(IDENTITY_MACRO, __VA_ARGS__) } name; static const char* name##__NAMES[] = { FIELDS(STRINGIFY, __VA_ARGS__) } /* NOLINT(unused-variable) */
